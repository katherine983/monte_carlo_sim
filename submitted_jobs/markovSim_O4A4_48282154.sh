...
#SBATCH --job-name=Order4Alph4nSim100	# Job name
#SBATCH --output='outputs/Order4Alph4nSim100_%j.out'	# Output file (stdout)
#SBATCH --error='errors/Order4Alph4nSim100_%j.err'	# Error file (stderr)
...
#SBATCH --array=0-1:1		# Number of jobs, in steps of 1
...
srun -l python main.py 1000 --nobs 500 1000 2500 5000 -d markov -o $myscratch --jobarray $SLURM_ARRAY_TASK_ID --markovname Order4Alph4
source deactivate

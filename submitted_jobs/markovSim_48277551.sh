...
#SBATCH --job-name=Alph4nSim100	# Job name
#SBATCH --output='outputs/Alph4nSim100_%j.out'	# Output file (stdout)
#SBATCH --error='errors/Alph4nSim100_%j.err'	# Error file (stderr)
...
srun -l python main.py 1000 --nobs 500 1000 2500 5000 -d markov -o $myscratch --jobarray $SLURM_ARRAY_TASK_ID --markovname Order1Alph4
source deactivate

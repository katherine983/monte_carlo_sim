...
#SBATCH --job-name=Order3Alph4nSim100	# Job name
#SBATCH --output='outputs/Order3Alph4nSim100_%j.out'	# Output file (stdout)
#SBATCH --error='errors/Order3Alph4nSim100_%j.err'	# Error file (stderr)
...
srun -l python main.py 1000 --nobs 500 1000 2500 5000 -d markov -o $myscratch --jobarray $SLURM_ARRAY_TASK_ID --markovname Order3Alph4
source deactivate
